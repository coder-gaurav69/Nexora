...
const ReviewForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col gap-4 w-[70%] p-4 shadow-md'>
      <div className='flex justify-between'>
        <h1 className='font-bold text-2xl'>Write a Review</h1>
        <IoClose className='font-bold text-4xl hover:scale-110 transition-transform duration-200' onClick={()=>setOpenReviewForm(false)}/>
      </div>
      ...
      {/* Review Title */}
      <label htmlFor="title" className='font-semibold text-[rgba(0,0,0,0.8)]'>Review Title *</label>
      <input
        type="text"
        id='title'
        required
      ...
      {/* Review Textarea */}
      <label htmlFor="review" className='font-semibold text-[rgba(0,0,0,0.8)]'>Your Review *</label>
      <textarea
        id="review"
        required
        minLength={50}
      ...
      {/* File Upload */}
      <label htmlFor="photo" className='font-semibold text-[rgba(0,0,0,0.8)]'>Add Photos (Optional)</label>
      ...
      {/* Name */}
      <label htmlFor="name" className='font-semibold text-[rgba(0,0,0,0.8)]'>Your Name *</label>
      <input
        type="text"
        id='name'
        required
      ...
      <div className='flex gap-5 items-start'>
        ...
        <p>
          I agree that this review is based on my own experience and is my genuine opinion
          of this product, and that I have no personal or business relationship with this company.
        </p>
      </div>
